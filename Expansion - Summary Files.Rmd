...
employment_by_age <- function(df) {
  ...
  df_tidy <- df %>%
    ...
    transmute(CBSA = CBSA,
              ...
              Employed_20_34 = (B23001e12 + B23001e14 + B23001e19 + B23001e21 + B23001e26 + B23001e28 + B23001e33 + B23001e35 + B23001e98 + B23001e100 + B23001e105 + B23001e107 + B23001e112 + B23001e114 + B23001e119 + B23001e121)/(!! census_sum("B23001e", 10, 31, 7) + !! census_sum("B23001e", 96, 117, 7)),
...
poverty_by_age <- function(df) {
  ...
  df_tidy <- df %>%
    ...
    transmute(CBSA = CBSA,
              ...
              Above_poverty_35_64 = !! census_sum_select("B1700e1", c(41, 42, 43, 55, 56, 57)),
              Above_poverty_65 = !! census_sumSelect("B17001e", c(44, 45, 58, 59)),
    ...
    arrange(desc(Prop_18_34)) %>%
    mutate(Rank_18_34 = row_number()) %>%
    arrange(desc(Prop_35_64)) %>%
    mutate(Rank_35_64 = row_number()) %>%
    arrange(desc(Employed_65_over)) %>%
    mutate(Rank_employed_65_over = row_number()) %>%
    unite(`16-19`, Employed_16_19, Rank_employed_16_19) %>%
    unite(`20-34`, Employed_20_34, Rank_employed_20_34) %>%
...
tenure_by_age <- function(df) {
  ...
  df_tidy <- df %>%
    ...
    transmute(CBSA = CBSA,
              ...
              Owner_occ_35_64 = (!! census_sum("B25007", 5, 8, 1))/(!! census_sum("B25007", 5, 8, 1) + !! census_sum("B25007", 15, 18, 1)),
