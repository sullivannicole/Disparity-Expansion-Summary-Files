...
parse(text = paste(rep(table), seq(from = start, to = end, by = int), sep = "", collapse = " + "))
  ...
  # Years 2009 and later use different table codes than 2007-2008 or 2005-2006
    df_pared <- df %>%
      ...
      transmute(CBSA = CBSA,
                ...
                Above_poverty_no_disability = eval(censusSum("B18130e", 8, 43, 7)),
                Prop_above_poverty_disability = Above_poverty_disability/(Above_poverty_disability + eval(censusSum("B18130e", 4, 39, 7))),
                Prop_above_poverty_no_disability = Above_poverty_no_disability/(Above_poverty_no_disability + eval(censusSum("B18130e", 7, 42, 7)))) %>%
    ...
    df_pared <- df %>%
      ...
      transmute(CBSA = CBSA,
                ...
                Prop_above_poverty_no_disability = (eval(censusSum("B18030e", 33, 42, 3)) + eval(censusSum("B18030e", 46, 55, 3)))/B18030e29)
    ...
    df_pared <- df %>%
      ...
      transmute(CBSA = CBSA,
                ...
                Above_poverty_disability = eval(censusSum("B18130e", 5, 40, 7)),
                Above_poverty_no_disability = eval(censusSum("B18130e", 8, 43, 7)),
                Prop_above_poverty_disability = Above_poverty_disability/(Above_poverty_disability + eval(censusSum("B18130e", 4, 39, 7))),
                Prop_above_poverty_no_disability = Above_poverty_no_disability/(Above_poverty_no_disability + eval(censusSum("B18130e", 7, 42, 7)))) %>%
      dplyr::select(-Above_poverty_disability, -Above_poverty_no_disability)
...
employment_by_age <- function(df) {
  ...
  df_tidy <- df %>%
    ...
    transmute(CBSA = CBSA,
              ...
              Employed_20_34 = (B23001e12 + B23001e14 + B23001e19 + B23001e21 + B23001e26 + B23001e28 + B23001e28 + B23001e33 + B23001e35 + B23001e98 + B23001e100 + B23001e105 + B23001e107 + B23001e112 + B23001e114 + B23001e119 + B23001e121)/(B23001e10 + B23001e17 + B23001e24 + B23001e31 + B23001e96 + B23001e103 + B23001e110 + B23001e117),
...
tenure_by_age <- function(df) {
  ...
  df_tidy <- df %>%
    ...
    transmute(CBSA = CBSA,
              ...
              Owner_occ_35_64 = (B25007e5 + B25007e6 + B25007e7 + B25007e8)/(B25007e5 + B25007e6 + B25007e7 + B25007e8 + B25007e15 + B25007e16 + B25007e17 + B25007e18),
